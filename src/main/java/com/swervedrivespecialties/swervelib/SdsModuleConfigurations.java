...
//FIXED if drive is backwards, adjust the true statements
public final class SdsModuleConfigurations {
    public static final ModuleConfiguration MK2_STANDARD = new ModuleConfiguration(
            0.1016,
    ...
    public static final ModuleConfiguration MK2_FAST = new ModuleConfiguration(
            0.1016,
            (18.0 / 38.0) * (24.0 / 20.0) * (15.0 / 60.0),
            true,
            (15.0 / 45.0) * (10.0 / 60.0),
            true
    );
