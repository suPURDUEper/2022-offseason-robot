 ...
 * Mk2 swerve module has two configurations, standard and fast, and therefore should have two configurations
 * ({@link SdsModuleConfigurations#Mk2_STANDARD} and {@link SdsModuleConfigurations#Mk2_FAST} respectively).
 */
