...
/**
 * Additional Mk2 module configuration parameters.
 * <p>
 * The configuration parameters here are used to customize the behavior of the Mk2 swerve module.
 * Each setting is initialized to a default that should be adequate for most use cases.
 */
public class Mk2ModuleConfiguration {
    ...
    public boolean equals(Object o) {
        ...
        Mk2ModuleConfiguration that = (Mk2ModuleConfiguration) o;
